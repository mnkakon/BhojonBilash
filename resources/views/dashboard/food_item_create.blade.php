...
@section('content')
	<div class="row">
		<div class="col-md-6 col-md-offset-3">
			<h1 class="text-center">Create New Food Item</h1>
			<div class="well">

				{!! Form::open(['route' => ['foodCreate', $authUser->restaurant_id], 'method' => 'post', 'files' => true]) !!}
					...
					<div class="form-group">
						{{ Form::label('category_id', 'Select your category *') }} <br>
						@foreach($categoriesList as $categoryList)
							{{ Form::radio('category_id', $categoryList->id) }} {{ $categoryList->category_name }} <br>
						@endforeach
					</div>
